import { Zap, Plus, Settings, BarChart2 } from 'lucide-react';
import { Link } from 'react-router-dom';

export default function MetersMain() {
  const meters = [
    { id: 1, number: '100456', status: 'Activo', lastReading: '12,450', date: '28/04/2026' },
    { id: 2, number: '200891', status: 'Inactivo', lastReading: '5,300', date: '15/03/2026' },
    { id: 3, number: '300124', status: 'Activo', lastReading: '8,900', date: '27/04/2026' },
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white">Mis Medidores</h1>
